...
class LineTests(TestCase):
    def test_hSectionProperties(self):
        a = section.hSectionProperties(200, 100, 5.5, 8, 8)
    ...
    def test_tSectionProperties(self):
        a = section.tSectionProperties(100, 100, 5.5, 8, 8)
